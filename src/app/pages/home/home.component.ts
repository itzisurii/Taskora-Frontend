...
@Component({
  selector: 'app-home',
  imports: [LoginInComponent, SignUpComponent, NavBarComponent, RouterOutlet, FooterComponent, NameContainerComponent, TaskListComponent, TaskCardComponent, TaskToolbarComponent, MainPageComponent, MainPage2Component, MainPage3Component],
